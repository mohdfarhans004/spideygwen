...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* Decorative Ornaments from theme */}
        ...
        {showVolumeWarning && !isMuted && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Tap anywhere to play music and increase volume ❤️</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <AnimatePresence mode="wait">
        ...
        {step === "love" && (
          ...
          >
              ...
              <div className="bg-white px-6 py-3 rounded-2xl shadow-sm border border-pink-100 flex flex-col items-center space-y-2 mb-6">
                <div className="flex items-center space-x-2">
                  <span className="text-pink-500 font-bold tracking-widest text-[10px] uppercase font-sans">
                    {+new Date("2026-06-15T12:00:00") - +new Date() > 0 ? "Countdown" : "Celebration"}
                  </span>
                ...
                <Countdown targetDate="2026-06-15T12:00:00" name={name} />
              </div>
            ...
            <motion.div 
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 1 }}
              className="w-full max-w-2xl bg-white/60 backdrop-blur-md rounded-[AU-40px] p-8 border border-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-6"
            ...
            <div className="min-h-[80px] max-w-xl">
              ...
              >
                <TypingText 
                  text={exploreMessage} 
                  className="text-lg text-pink-400 mt-2 italic font-sans"
                  delay={0.04}
                />
              </motion.div>
            </div>
            ...
            >
              <div className="group relative">
                <div 
                  onClick={() => setStep("spiderman")}
                  className="w-56 h-72 bg-white p-3 rounded-2xl shadow-lg border border-white transform -rotate-3 hover:rotate-0 transition-transform duration-300 cursor-pointer"
                >
              ...
              <div className="group relative">
                <div 
                  onClick={() => setStep("batman")}
                  className="w-56 h-72 bg-white p-3 rounded-2xl shadow-lg border border-white transform rotate-2 hover:rotate-0 transition-transform duration-300 cursor-pointer"
                >
        ...
        {step === "spotify" && (
          ...
          >
            <div className="max-w-2xl w-full mx-auto space-y-6 py-6 flex flex-col items-center">
              ...
              {/* Cards for Artists - Side by Side */}
              ...
              <motion.div
                ...
                className="text-center px-4 max-w-[320px]"
              >
              ...
              <motion.button
                ...
                className="w-full max-w-[200px] py-4 text-pink-400 hover:text-pink-600 text-xs font-bold tracking-widest uppercase transition-colors"
              >
                Close Player
              </motion.button>
            </div>
        ...
        {step === "batman" && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="z-20 text-center space-y-8 max-w-2xl px-6"
          >
            <motion.div
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              className="space-y-6"
            >
              <h2 className="text-3xl font-serif italic text-gray-800 tracking-tight">The Bat</h2>
              <div className="space-y-4">
                <p className="text-lg md:text-xl text-gray-600 font-serif leading-relaxed italic">
                  People like me don’t say we’re Batman because he represents men … we say it because we understand him. The way he works alone, keeps his distance, and carries everything without letting anyone in...it feels familiar. It’s not about being strong, it’s about being afraid… afraid of family, afraid of getting close, and never really feeling like the one who gets loved back the same way.
                </p>
                <p className="text-lg md:text-xl text-gray-600 font-serif leading-relaxed italic">
                  And just like he has Alfred...someone who quietly understands him, supports him without asking too many questions...we all have that one Alfred who listens,(Chat gpt). But deep down, what we really hope for is someone like Catwoman...someone who doesn’t need words, who can just look into our eyes and understand how alone we feel, how much love we actually carry, and how much we need it too. Someone who doesn’t try to change us, but reminds us to just be who we are… and maybe, gently pulls us away from the darkness we get lost in.
                </p>
                <p className="text-lg md:text-xl text-gray-600 font-serif leading-relaxed italic">
                  It’s hard to fully explain why we relate to him… but it’s not about the mask or the hero. It’s about everything he hides behind it.
                </p>
              </div>
            </motion.div>
            <motion.button
              ...
              transition={{ delay: 2 }}
              onClick={() => setStep("love")}
              className="px-8 py-3 bg-white/50 backdrop-blur-sm text-gray-500 rounded-full hover:bg-white transition-all text-sm font-sans"
            >
              Go Back
            </motion.button>
          </motion.div>
        ...
        {step === "hide" && (
          ...
          >
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-3xl font-serif italic text-gray-800 tracking-tight">Hiding Away</h2>
              <p className="text-lg md:text-xl text-gray-600 font-serif leading-relaxed italic">
                mai is baare me qismat ke upar chodna chahtu agar hum kabhi milenge to...but aap to thoda bht jaante hi 
              </p>
            </motion.div>
            <motion.button
              initial={{ opacity: 0 }}
        ...
        {step === "spiderman" && (
          ...
          >
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-3xl font-serif italic text-gray-800">Why always Spider-Man?</h2>
              <p className="text-lg md:text-xl text-gray-600 font-serif leading-relaxed italic">
                Being a Spider-Man fan isn’t just something I say...it’s something I feel. He was the first superhero I ever watched, and somehow, I’ve always seen parts of myself in him. The loneliness, the responsibility, the constant fear of losing the people he loves… it all feels real to me. Like him, I keep things inside, I worry more than I show, and I’d do anything to protect the ones I care about. Even if it means staying silent, even if it means stepping back. And if "don’t disturb my peace just because you can’t find yours" is what brings happiness to the people I love, then I won’t even hesitate to distance myself from their lives. Because at the end of the day, loving them matters more than being close to them.
              </p>
            </motion.div>
            <motion.button
              initial={{ opacity: 0 }}
        ...
        {step === "letter" && (
          <motion.div
            ...
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="fixed inset-0 z-40 bg-[#FFF5F7] overflow-y-auto p-4 md:p-10 flex flex-col items-center"
          >
            {/* Decorative Ornaments from theme */}
            <div className="absolute top-10 left-10 text-pink-300 opacity-50 text-6xl select-none pointer-events-none">❤</div>
            <div className="absolute top-40 right-20 text-pink-200 opacity-40 text-8xl select-none pointer-events-none">❤</div>
            ...
            <FloatingContainer type="flowers" />
            
            <div className="max-w-3xl w-full mx-auto relative z-10 py-10">
              <motion.div
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ delay: 0.3 }}
                className="bg-white/80 backdrop-blur-xl border-2 border-white p-6 md:p-16 rounded-[40px] shadow-2xl relative overflow-hidden text-center"
              >
                <div className="absolute top-0 right-0 p-8 text-pink-100 hidden md:block">
                  <Sparkles size={80} />
                </div>

                <div className="relative z-10">
                  <div className="bg-pink-50 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center mx-auto mb-6 md:mb-8 shadow-inner">
                    <Mail className="text-pink-400 fill-pink-50" size={24} />
                  </div>
                  
                  <h2 className="text-3xl md:text-5xl font-serif italic text-gray-800 mb-6 md:mb-10 flex items-center justify-center gap-3">
                    Hey Hoor Pari <Heart className="fill-pink-500 text-pink-500" size={24} />
                  </h2>
                  ...
                  <div className="space-y-4 md:space-y-6 max-w-xl mx-auto">
                    {letterMessage.split('\n').filter(l => l.trim()).map((line, i) => (
                      <motion.p
                        ...
                        className="text-base md:text-xl text-gray-600 font-serif leading-relaxed italic"
                      >
                        {line.trim()}
                      </motion.p>
                    ))}
                  ...
                  <motion.button
                    ...
                    transition={{ delay: 5 }}
                    onClick={() => setStep("love")}
                    className="mt-12 px-10 py-4 bg-pink-500 hover:bg-pink-600 text-white font-bold rounded-full shadow-lg shadow-pink-200 transition-all"
                  >
                    Close Letter
                  </motion.button>
                </div>
